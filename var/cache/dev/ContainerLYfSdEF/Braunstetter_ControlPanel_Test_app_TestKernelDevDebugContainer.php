 ...
 */
class Braunstetter_ControlPanel_Test_app_TestKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->aliases = [
            'Braunstetter\\ControlPanel\\Test\\app\\TestKernel' => 'kernel',
        ];
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/Braunstetter_ControlPanel_Test_app_TestKernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Braunstetter_ControlPanel_Test_app_TestKernelDevDebugContainer',
