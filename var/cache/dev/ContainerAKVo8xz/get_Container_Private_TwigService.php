 ...
 */
class get_Container_Private_TwigService extends Braunstetter_ControlPanel_Test_app_src_TestKernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/braunstetter/assets-push-bundle/src/Twig/Extension.php';
        include_once \dirname(__DIR__, 4).'/vendor/rybakit/twig-deferred-extension/src/DeferredExtension.php';
        include_once \dirname(__DIR__, 4).'/vendor/braunstetter/template-hooks-bundle/src/Twig/Extension.php';
        include_once \dirname(__DIR__, 4).'/vendor/braunstetter/template-hooks-bundle/src/Twig/Renderer.php';
        ...
        $a->addPath((\dirname(__DIR__, 4).'/Resources/views'), 'ControlPanel');
        $a->addPath((\dirname(__DIR__, 4).'/Resources/views'), '!ControlPanel');
        ...
        $instance->addExtension(new \Braunstetter\AssetsPushBundle\Twig\Extension());
        $instance->addExtension(new \Twig\DeferredExtension\DeferredExtension());
        $instance->addExtension(new \Braunstetter\TemplateHooks\Twig\Extension(new \Braunstetter\TemplateHooks\Twig\Renderer(new RewindableGenerator(function () use ($container) {
            return new \EmptyIterator();
        }, 0), $instance)));
