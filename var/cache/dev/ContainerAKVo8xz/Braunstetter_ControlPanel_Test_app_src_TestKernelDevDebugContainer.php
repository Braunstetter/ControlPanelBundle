 ...
 */
class Braunstetter_ControlPanel_Test_app_src_TestKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Braunstetter\\ControlPanel\\Test\\app\\src\\Controller\\TestController' => 'getTestControllerService',
        ...
        $this->aliases = [
            'Braunstetter\\ControlPanel\\Test\\app\\src\\TestKernel' => 'kernel',
        ];
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/Braunstetter_ControlPanel_Test_app_src_TestKernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'AssetsPushBundle' => 'Braunstetter\\AssetsPushBundle\\AssetsPushBundle',
                'TemplateHooksBundle' => 'Braunstetter\\TemplateHooks\\TemplateHooksBundle',
                'ControlPanelBundle' => 'Braunstetter\\ControlPanel\\ControlPanelBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'AssetsPushBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/braunstetter/assets-push-bundle/src'),
                    'namespace' => 'Braunstetter\\AssetsPushBundle',
                ],
                'TemplateHooksBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/braunstetter/template-hooks-bundle/src'),
            ...
            'kernel.container_class' => 'Braunstetter_ControlPanel_Test_app_src_TestKernelDevDebugContainer',
